...
class LineService:
    ...
    def _get_api(self):
        ...
        channel_access_token = current_app.config.get("T9XWnadcXX7W5F3+aOUTB4LOko6IxC+q3GboLpop+AqKk8BwNh+p2UJ8fvg8Qbds8bVSuNgZdzVqAnjE6v6OIo8/3KOVjWihsDQGa56PcpfI1gjvvAq1Eo5SOuP3IsVb31PAMQUebJmuVoK/scJBswdB04t89/1O/w1cDnyilFU=")
